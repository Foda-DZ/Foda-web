...
export default function TermsPage() {
  ...
  const { badge, title, subtitle, sections } = tr.legal.terms;
  ...
  return (
    <main className="min-h-screen bg-[#0d0d1a]">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <div className="mt-12 p-5 rounded-2xl border border-white/8 bg-white/2 flex items-start gap-4">
          ...
          <button
            ...
            className="shrink-0 text-xs font-semibold text-gold hover:text-gold/80 transition-colors border border-gold/25 hover:border-gold/40 px-3 py-1.5 rounded-lg"
          >
            {tr.footer.privacy} →
          </button>
        </div>
